...
import { SeasonHeroSection } from './season-hero-section'
...
interface SeasonRecapReportProps {
  data: SeasonRecapData
}

export function SeasonRecapReport({ data }: SeasonRecapReportProps) {
  const { recap, organization, season, partner, events, deliverables, stats } = data
