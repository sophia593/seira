...
export const EXTENDED_PROMPTS: ExtendedPrompt[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    exampleId: 'billie-eilish',
    label: 'billie eilish',
    fullQuery: 'Billie Eilish Hit Me Hard and Soft Tour, any date on the West Coast, floor seats preferred',
    category: 'concerts',
    subcategory: 'pop',
  ...
  {
    id: 'bad-bunny-stadium',
    exampleId: 'bad-bunny',
    label: 'bad bunny',
    fullQuery: 'Bad Bunny concert, anywhere in the US, want good seats not nosebleeds',
    category: 'concerts',
    subcategory: 'latin',
    tags: ['latin', 'stadium', 'premium'],
  },
  {
    id: 'drake-tour',
    exampleId: 'billie-eilish',
  ...
  },
  {
    ...
    exampleId: 'billie-eilish',
    label: 'the weeknd',
    fullQuery: 'The Weeknd tour, LA or Vegas show, 2 tickets',
    category: 'concerts',
    subcategory: 'pop',
    tags: ['pop', 'r&b'],
  },
  {
    ...
    fullQuery: 'Kendrick Lamar concert, somewhere in California, October or November',
    category: 'concerts',
    subcategory: 'hiphop',
    tags: ['hiphop', 'trending'],
  },
